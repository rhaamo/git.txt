...
func confAppIni() (*asset, error) {
	...
	info := bindataFileInfo{name: "conf/app.ini", size: 3096, mode: os.FileMode(420), modTime: time.Unix(1494080228, 0)}
